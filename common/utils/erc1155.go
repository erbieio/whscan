...
func init() {
	...
	ERC1155ABI, _ = abi.JSON(strings.NewReader(erc1155))
}
...
func Unpack1155TransferSingleLog(log Log) (out ERC1155TransferSingle, err error) {
	err = UnpackLog(ERC1155ABI, &out, "TransferSingle", log)
	return
}

func Unpack1155TransferBatchLog(log Log) (out ERC1155TransferBatch, err error) {
	err = UnpackLog(ERC1155ABI, &out, "TransferBatch", log)
	return
}
